...
(function () {
  ...
  var STORE = "tarven-lang";

  /* Sözlük anahtarı = sayfadaki Türkçe metnin boşlukları sadeleştirilmiş hâli. */
  var DICT = {
    ru: {
      "Tarven Group — Market, İnşaat ve Enerji": "Tarven Group — ритейл, строительство и энергетика",
      ...
      "Tarven Group çatısı altındaki işler kendi alanlarında bağımsız yürütülür; ancak hepsi aynı kurumsal ölçütle denetlenir.": "Направления в составе Tarven Group ведутся самостоятельно в своих областях, но контролируются по единым корпоративным критериям.",
      "Bize ulaşın": "Свяжитесь с нами",
      "Faaliyet sektörü": "Отрасли деятельности",
      "Amiral proje alanı": "Площадь флагманского проекта",
      "Mağaza · Tarven Park": "Магазины · Tarven Park",
      "Konut · Tarven Park": "Жильё · Tarven Park",
      "Amiral projemiz": "Наш флагманский проект",
      "2020 · Karma kullanım": "2020 · Смешанное назначение",
      "Tarven Park Alışveriş ve Yaşam Merkezi": "Торгово-жилой центр Tarven Park",
      "2020 yılında": "В 2020 году",
      "hizmete açılan Tarven Park, bölgenin ilk ve tek alışveriş merkezi. Alışveriş, eğlence ve konut aynı projede bir araya getirildi — planlamadan teslimata kadar tüm süreç grup bünyesinde yürütüldü.": "открытый Tarven Park — первый и единственный торговый центр региона. Торговля, развлечения и жильё объединены в одном проекте: весь процесс от планирования до сдачи вёлся силами группы.",
      ...
      "Tarven Group. Tüm hakları saklıdır.": "Tarven Group. Все права защищены.",
      "İnşaat ve Taahhüt — Tarven Group": "Строительство и подряд — Tarven Group",
      ...
      "Tarven Group'un diğer alanları": "Другие направления Tarven Group",
      "Tarven Park Alışveriş ve Yaşam Merkezi — alışveriş, market ve perakende.": "Торгово-жилой центр Tarven Park — торговля, ритейл и розница.",
      ...
      "Enerji — Tarven Group": "Энергетика — Tarven Group",
      ...
      "Hakkımızda — Tarven Group": "О нас — Tarven Group",
      "Üç sektör,": "Три отрасли,",
      "bir anlayış.": "один подход.",
      "Tarven Group; market ve perakende, inşaat ve taahhüt, enerji alanlarında faaliyet gösteren bir gruptur. Her iş kendi alanında bağımsız yürütülür; hepsi aynı kurumsal ölçütle denetlenir.": "Tarven Group — группа, работающая в сферах ритейла и розничной торговли, строительства и подряда, энергетики. Каждое направление ведётся самостоятельно, но контролируется по единым корпоративным критериям.",
      "01 — Kimiz": "01 — Кто мы",
      ...
      "Tarven Park Alışveriş ve Yaşam Merkezi ile alışveriş, market ve günlük yaşam bir arada.": "Торгово-жилой центр Tarven Park: торговля, ритейл и повседневная жизнь вместе.",
      ...
      "İletişim — Tarven Group": "Контакты — Tarven Group",
      ...
      "Tarven Group merkez ofis · Harita: © OpenStreetMap": "Головной офис Tarven Group · Карта: © OpenStreetMap",
      "Hangi konuda görüşmek istiyorsunuz?": "По какому вопросу вы хотите связаться?",
      "Tarven Park Alışveriş ve Yaşam Merkezi hakkında bilgi ve talepler.": "Информация и запросы по торгово-жилому центру Tarven Park.",
      ...
      "Sayfa bulunamadı — Tarven Group": "Страница не найдена — Tarven Group",
      ...
      "Tarven Group ana sayfa": "Tarven Group — главная",
      "Menüyü aç": "Открыть меню",

      "Tarven Park — Alışveriş ve Yaşam Merkezi | Tarven Group": "Tarven Park — торгово-жилой центр | Tarven Group",
      "01 — Alışveriş ve yaşam merkezi": "01 — Торгово-жилой центр",
      "Her şey,": "Всё —",
      "tek çatıda.": "под одной крышей.",
      "Tarven Park Alışveriş ve Yaşam Merkezi; 2020'den bu yana bölgenin ilk ve tek AVM'si olarak alışverişi, eğlenceyi ve günlük yaşamı açık hava konseptinde bir araya getirir.": "Торгово-жилой центр Tarven Park с 2020 года — первый и единственный ТЦ региона, объединяющий покупки, развлечения и повседневную жизнь в открытой концепции.",
      ...
      "ve": "и",
      "yaşam alanıyla Tarven Park; bölge için bir alışveriş, eğlence ve yaşam noktasıdır.": "жилой зоны — Tarven Park стал точкой покупок, развлечений и жизни для региона.",
      ...
      "Konum": "Расположение",
      "Karahan · Şırnak": "Джизре · Ширнак",
      "Konak Mahallesi, Karahan-Değirmenli Yolu, Karahan / Şırnak — Irak-Değirmenli, Yeni Şırnak ve Yeşiltepe yollarının kesişiminde. Harita yaklaşık konumu gösterir. Harita: © OpenStreetMap.": "Район Конак, шоссе Джизре — Силопи, Джизре / Ширнак — на пересечении дорог Ирак-Силопи, Новый Ширнак и Мардин. Карта показывает приблизительное расположение. Карта: © OpenStreetMap.",
      "Ziyaret bilgileri": "Информация для посещения",
      "Gün ışığı alan açık hava konsepti ve ferah alanlarıyla Tarven Park, hafta boyunca ziyaretçilerini ağırlar.": "Благодаря открытой концепции с естественным светом и просторным зонам Tarven Park принимает посетителей всю неделю.",
      ...
      "Tarven Park'tan": "Из Tarven Park",
      "Gerçek görseller": "Реальные фотографии",
      "Tarven Park Alışveriş ve Yaşam Merkezi'nden kareler.": "Кадры из торгово-жилого центра Tarven Park.",
    ...
    en: {
      "Tarven Group — Market, İnşaat ve Enerji": "Tarven Group — Retail, Construction and Energy",
      ...
      "Tarven Group çatısı altındaki işler kendi alanlarında bağımsız yürütülür; ancak hepsi aynı kurumsal ölçütle denetlenir.": "The businesses under Tarven Group run independently in their own fields, yet all are held to the same corporate standard.",
      "Bize ulaşın": "Get in touch",
      "Faaliyet sektörü": "Sectors of operation",
      "Amiral proje alanı": "Flagship project area",
      "Mağaza · Tarven Park": "Stores · Tarven Park",
      "Konut · Tarven Park": "Homes · Tarven Park",
      "Amiral projemiz": "Our flagship project",
      "2020 · Karma kullanım": "2020 · Mixed use",
      "Tarven Park Alışveriş ve Yaşam Merkezi": "Tarven Park Shopping and Living Centre",
      "2020 yılında": "Opened in 2020,",
      "hizmete açılan Tarven Park, bölgenin ilk ve tek alışveriş merkezi. Alışveriş, eğlence ve konut aynı projede bir araya getirildi — planlamadan teslimata kadar tüm süreç grup bünyesinde yürütüldü.": "Tarven Park is the region's first and only shopping centre. Retail, entertainment and housing were brought together in one project — the entire process, from planning to handover, was carried out within the group.",
      ...
      "Tarven Group. Tüm hakları saklıdır.": "Tarven Group. All rights reserved.",
      "İnşaat ve Taahhüt — Tarven Group": "Construction and Contracting — Tarven Group",
      ...
      "Tarven Group'un diğer alanları": "Other areas of Tarven Group",
      "Tarven Park Alışveriş ve Yaşam Merkezi — alışveriş, market ve perakende.": "Tarven Park Shopping and Living Centre — shopping, retail and commerce.",
      ...
      "Enerji — Tarven Group": "Energy — Tarven Group",
      ...
      "hizmete açılan Tarven Park, bölgenin ilk ve tek alışveriş merkezi olarak planlandı. Alışveriş, eğlence ve konut tek bir projede bir araya getirildi; süreç planlamadan teslimata kadar grup bünyesinde yürütüldü.": "Tarven Park was planned as the region's first and only shopping centre. Retail, entertainment and housing were brought together in a single project; the process was carried out within the group from planning to handover.",
      ...
      "Tarven Park Alışveriş ve Yaşam Merkezi ile alışveriş, market ve günlük yaşam bir arada.": "With Tarven Park Shopping and Living Centre, shopping, retail and everyday life come together.",
      ...
      "Bizi arayın": "Call us",
      "İletişim — Tarven Group": "Contact — Tarven Group",
      ...
      "Tarven Group merkez ofis · Harita: © OpenStreetMap": "Tarven Group head office · Map: © OpenStreetMap",
      "Hangi konuda görüşmek istiyorsunuz?": "What would you like to talk about?",
      "Tarven Park Alışveriş ve Yaşam Merkezi hakkında bilgi ve talepler.": "Information and enquiries about Tarven Park Shopping and Living Centre.",
      ...
      "Sayfa bulunamadı — Tarven Group": "Page not found — Tarven Group",
      ...
      "Ana menü": "Main menu",
      "Tarven Group ana sayfa": "Tarven Group home",
      "Menüyü aç": "Open menu",

      "Tarven Park — Alışveriş ve Yaşam Merkezi | Tarven Group": "Tarven Park — Shopping and Living Centre | Tarven Group",
      "01 — Alışveriş ve yaşam merkezi": "01 — Shopping and living centre",
      "Her şey,": "Everything,",
      "tek çatıda.": "under one roof.",
      "Tarven Park Alışveriş ve Yaşam Merkezi; 2020'den bu yana bölgenin ilk ve tek AVM'si olarak alışverişi, eğlenceyi ve günlük yaşamı açık hava konseptinde bir araya getirir.": "Since 2020 Tarven Park Shopping and Living Centre has been the region's first and only mall, bringing shopping, entertainment and everyday life together in an open-air concept.",
      ...
      "26 mağaza": "26 stores",
      "ve": "and",
      "yaşam alanıyla Tarven Park; bölge için bir alışveriş, eğlence ve yaşam noktasıdır.": "of living space make Tarven Park a place to shop, be entertained and live for the region.",
      ...
      "Konum": "Location",
      "Karahan · Şırnak": "Karahan · Şırnak",
      "Konak Mahallesi, Karahan-Değirmenli Yolu, Karahan / Şırnak — Irak-Değirmenli, Yeni Şırnak ve Yeşiltepe yollarının kesişiminde. Harita yaklaşık konumu gösterir. Harita: © OpenStreetMap.": "Konak District, Karahan–Değirmenli Road, Karahan / Şırnak — at the junction of the Iraq–Değirmenli, New Şırnak and Yeşiltepe roads. The map shows the approximate location. Map: © OpenStreetMap.",
      "Ziyaret bilgileri": "Visitor information",
      "Gün ışığı alan açık hava konsepti ve ferah alanlarıyla Tarven Park, hafta boyunca ziyaretçilerini ağırlar.": "With its daylight-filled open-air concept and spacious areas, Tarven Park welcomes visitors all week.",
      ...
      "Tarven Park'tan": "From Tarven Park",
      "Gerçek görseller": "Real photographs",
      "Tarven Park Alışveriş ve Yaşam Merkezi'nden kareler.": "Shots from Tarven Park Shopping and Living Centre.",
  ...
  function collect() {
    ...
    while ((n = walker.nextNode())) {
      ...
      if (n.__tarvenSource === undefined) n.__tarvenSource = n.nodeValue;
      nodes.push({ node: n, tr: n.__tarvenSource });
    }
    return nodes;
  }
